...
1. **레포에 이미지 커밋 (권장)**: 이미지를 [`public/post-images/`](./public/post-images/) 에 올린 뒤, 노션 `thumbnail` 컬럼에 GitHub Pages URL 임베드. 예: `https://imweb-tech.github.io/imweb_techblog/post-images/<파일명>`
